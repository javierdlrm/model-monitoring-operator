...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InferenceAdapterConfig) DeepCopyInto(out *InferenceAdapterConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InferenceAdapterConfig.
func (in *InferenceAdapterConfig) DeepCopy() *InferenceAdapterConfig {
	if in == nil {
		return nil
	}
	out := new(InferenceAdapterConfig)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InferenceAdapterSpec) DeepCopyInto(out *InferenceAdapterSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InferenceAdapterSpec.
func (in *InferenceAdapterSpec) DeepCopy() *InferenceAdapterSpec {
	if in == nil {
		return nil
	}
	out := new(InferenceAdapterSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ModelMonitorConfig) DeepCopyInto(out *ModelMonitorConfig) {
	*out = *in
	...
	if in.InferenceAdapter != nil {
		in, out := &in.InferenceAdapter, &out.InferenceAdapter
		*out = new(InferenceAdapterConfig)
		**out = **in
	}
}
...
func (in *ModelMonitorSpec) DeepCopyInto(out *ModelMonitorSpec) {
	*out = *in
	...
	out.InferenceAdapter = in.InferenceAdapter
	out.Kafka = in.Kafka
}
